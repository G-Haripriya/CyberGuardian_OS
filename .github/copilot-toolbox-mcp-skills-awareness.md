...
_Generated: 2026-07-20T17:00:04.127Z_
...
Workspace `mcp.json` _(folder: cyberguardian-os)_

- **c:\MY_Tools_Innovation\cyberguardian-os\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\HARIPRIYA\AppData\Roaming\Code\User\mcp.json** — _File missing_
...
- **developing-with-streamlit** — `C:\Users\HARIPRIYA\.agents\skills\developing-with-streamlit`
